...
//Inequality test
console.log("Inequality test with strings:", "Banana" !== "orange"); //true
...
console.log("Lowercase function test:", "HELLO" === "hello"); //false
// Numerical tests involving equality 
console.log("Equality test with numbers:", 5 === 5); //true
console.log("Equality test with numbers:", 5 !== 5); //false
// Numerical tests involving inequality 
console.log("Inequality test with numbers:", 2 !== 3); //true
console.log("Inequality test with numbers:", 2 === 3); //false
//greater than test 
